...
public class SajatAdatok extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Kedvezmény:");

        kedvezmeny.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Közalkalmazott", "Diák", "Kiskorú(50%)", "65 év felett(100%)", "Félárva(90%)", "Fogyatékkal élő személy(90%)", "Nincs kedvezmény" }));
        kedvezmeny.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(kedvezmeny, javax.swing.GroupLayout.Alignment.LEADING, 0, 1, Short.MAX_VALUE)
                                        .addComponent(szulido, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(kedvezmeny, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void save_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save_btnActionPerformed
        ...
        try {
        String query = "INSERT INTO utas (vezeteknev,keresztnev,telefon,email,szulido,iranyitoszam,varos,utca,hazszam,jelszo) values (?,?,?,?,?,?,?,?,?,?)";
            PreparedStatement pst =connection.prepareStatement(query);
            pst.setString(1, vezeteknev.getText());
            pst.setString(2, keresztnev.getText());
            pst.setString(3, telszam.getText());
            pst.setString(4, email.getText());
            pst.setString(5, szulido.getText());
            pst.setString(6, iranyitoszam.getText());
